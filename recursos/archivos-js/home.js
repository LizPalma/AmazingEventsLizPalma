...
//Pintado las cartas de forma dianmica 
...
const displayEvents = (events) => {
    ...
    events.forEach(event => {
        ...
        eventDiv.innerHTML = `
        <div class="card m-1">
                <img src="${event.image}" class="card-img-top h-50" alt="Festival of the collectivities">
                <div class="card-body">
...
const generateFilters = () => {
    ...
    categories.forEach((category, index) => {
        ...
        filterDiv.classList.add('form-check', 'form-check-inline'); //conexion dinamica entre busqueda 
